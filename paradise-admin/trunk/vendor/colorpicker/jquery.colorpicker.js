        ...
        function initColor(){
            ...
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
                    ...
                    for (k=0;k<3;k++){
                        for (l=0;l<6;l++){
                            // 000000  003300 006600 009900 00ff00 00ee00
            ...
            colorTable='<table width=300 border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;">'
            ...
            +'<table id="CT" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse;width: 300px" bordercolor="000000"  style="cursor:pointer;">'
            +colorTable+'</table>';
